...
const canvas = document.querySelector("canvas"),
    tollBtns = document.querySelectorAll(".tool"),
...
const drawCircle = (e) => {
    ...
    ctx.arc(prevMouseX, prevMouseY, redius, 0, 2 * Math.PI); // creating circle according to the mouse pointer
